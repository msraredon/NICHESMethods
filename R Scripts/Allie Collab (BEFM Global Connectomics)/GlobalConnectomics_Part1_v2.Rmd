...
table(Idents(merge))
downsampled <- subset(merge,cells = WhichCells(merge,downsample = 1000)) #1K for testing, 5K for publication
...
#save(global.connectomics,file = 'global.connectomics.2023-10-27.Robj') # hold for knit
