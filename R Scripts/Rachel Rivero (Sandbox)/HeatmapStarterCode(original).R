...
# Set WD
setwd("/Users/rr792/Documents/GitHub/NICHESMethods/R Scripts/Rachel Rivero (Sandbox)")
...
source('/Users/rr792/Documents/GitHub/NICHESMethods/R Scripts/Rachel Rivero (Sandbox)/CustomHeatmapOnly3.R')

# Load data
load("/Users/rr792/Documents/Manuscript Worthy_CDH/E17_labeled.Robj")
...
FRL17.Seurat$CellClass <- factor(FRL17.Seurat$CellClass,
                                 levels=c('Epithelial','Endothelial','Mesenchymal','Immune')) # feel free to modify the order here
...
col.pal <- list()
col.pal$CellType <- NULL # Add desired palette here
col.pal$Condition <- c('red','blue') # Add desired palette here
col.pal$Sample <- c('orange','purple','yellow','black') # Add desired palette here
...
downsampled <- subset(FRL17.Seurat, downsample = 9804) # same number of cells from each condition, but allows celltype distributions to stay real
...
row.labels <- c('Sox9','Sox10','Gucy1a2','Sox7','Mmrn1','Sox17','Wt1','Ptprc','Prrx1','Rspo2','Cftr') # etc etc...add as you see fit...pull from marker list...experiment
...
CustomHeatmapOnly3(object = downsampled,
                   ...
                   primary.cols = NULL, # Needs to be a named list of colors
