...
CircuitPlot_quadratic <- function(transcr.obj,
                        connect.obj,
                        feature,
                        plot.function = 'ggCircuit_quadratic',
                        group.by = 'CellClass',
                        graph.angle = 45,
                        h = 0.2,
                        offset = 0.05,
  ...
  if (plot.function == 'ggCircuit_quadratic') {
    circuit.plot <- ggCircuit_quadratic(node.aggregate = node.aggregate,
