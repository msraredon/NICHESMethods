NICHES_FeaturePlot <- function(transcriptome.object, # scRNAseq object containing all populations within which edges will be plotted. The embedding of this object will determine the shape of the graph.
